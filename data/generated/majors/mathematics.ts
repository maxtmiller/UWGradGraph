...
import { MATHEMATICS_REQS  } from "../reqs/mathematics";
import { MATHEMATICS_PLAN } from "../terms/mathematics";
import { COMPUTER_SCIENCE_REQS  } from "../reqs/computer-science";
import { COMPUTER_SCIENCE_PLAN } from "../terms/computer-science";
import { COMPUTING_AND_FINANCIAL_MANAGEMENT_REQS  } from "../reqs/computing-and-financial-management";
import { COMPUTING_AND_FINANCIAL_MANAGEMENT_PLAN } from "../terms/computing-and-financial-management";
import { DATA_SCIENCE_REQS  } from "../reqs/data-science";
import { DATA_SCIENCE_PLAN } from "../terms/data-science";
...
import { MATHEMATICS_AND_BUSINESS_REQS  } from "../reqs/mathematics-and-business";
import { MATHEMATICS_AND_BUSINESS_PLAN } from "../terms/mathematics-and-business";
...
import { MATHEMATICS_CHARTERED_PROFESSIONAL_ACCOUNTANCY_REQS  } from "../reqs/mathematics-chartered-professional-accountancy";
import { MATHEMATICS_CHARTERED_PROFESSIONAL_ACCOUNTANCY_PLAN } from "../terms/mathematics-chartered-professional-accountancy";
import { MATHEMATICS_FINANCIAL_ANALYSIS_AND_RISK_MANAGEMENT_REQS  } from "../reqs/mathematics-financial-analysis-and-risk-management";
import { MATHEMATICS_FINANCIAL_ANALYSIS_AND_RISK_MANAGEMENT_PLAN } from "../terms/mathematics-financial-analysis-and-risk-management";
...
const Mathematics: Major = {
  id:                "mathematics",
  name:              "Mathematics",
  faculty:           "mathematics",
  color:             "#FFD54F",
  requirementGroups: MATHEMATICS_REQS,
  defaultTermPlan:   MATHEMATICS_PLAN,
};
...
const ComputingAndFinancialManagement: Major = {
  id:                "computing-and-financial-management",
  name:              "Computing and Financial Management",
  faculty:           "mathematics",
  color:             "#FFD54F",
  requirementGroups: COMPUTING_AND_FINANCIAL_MANAGEMENT_REQS,
  defaultTermPlan:   COMPUTING_AND_FINANCIAL_MANAGEMENT_PLAN,
};
...
const DataScience: Major = {
  ...
  faculty:           "mathematics",
  color:             "#FFD54F",
  requirementGroups: DATA_SCIENCE_REQS,
  defaultTermPlan:   DATA_SCIENCE_PLAN,
};
...
const MathematicsAndBusiness: Major = {
  id:                "mathematics-and-business",
  name:              "Mathematics and Business",
  faculty:           "mathematics",
  color:             "#FFD54F",
  requirementGroups: MATHEMATICS_AND_BUSINESS_REQS,
  defaultTermPlan:   MATHEMATICS_AND_BUSINESS_PLAN,
};
...
const MathematicsCharteredProfessionalAccountancy: Major = {
  id:                "mathematics-chartered-professional-accountancy",
  name:              "Mathematics/Chartered Professional Accountancy",
  faculty:           "mathematics",
  color:             "#FFD54F",
  requirementGroups: MATHEMATICS_CHARTERED_PROFESSIONAL_ACCOUNTANCY_REQS,
  defaultTermPlan:   MATHEMATICS_CHARTERED_PROFESSIONAL_ACCOUNTANCY_PLAN,
};

const MathematicsFinancialAnalysisAndRiskManagement: Major = {
  id:                "mathematics-financial-analysis-and-risk-management",
  name:              "Mathematics/Financial Analysis and Risk Management",
  faculty:           "mathematics",
  color:             "#FFD54F",
  requirementGroups: MATHEMATICS_FINANCIAL_ANALYSIS_AND_RISK_MANAGEMENT_REQS,
  defaultTermPlan:   MATHEMATICS_FINANCIAL_ANALYSIS_AND_RISK_MANAGEMENT_PLAN,
};
...
export const MATHEMATICS_MAJORS: Record<string, Major> = {
  ...
  "computing-and-financial-management": ComputingAndFinancialManagement,
...
export const MATHEMATICS_SUB_MAJORS: Record<string, Major> = {
  ...
  "mathematics-and-business": MathematicsAndBusiness,
  ...
  "mathematics-chartered-professional-accountancy": MathematicsCharteredProfessionalAccountancy,
  "mathematics-financial-analysis-and-risk-management": MathematicsFinancialAnalysisAndRiskManagement,
